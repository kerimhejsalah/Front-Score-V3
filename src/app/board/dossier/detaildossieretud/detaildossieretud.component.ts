...
@Component({
  selector: 'app-detaildossieretud',
  templateUrl: './detaildossieretud.component.html',
  styleUrls: ['./detaildossieretud.component.css']
})
export class DetaildossieretudComponent implements OnInit {
...
export class NgbdModalContent {
  ...
  constructor(public activeModal: NgbActiveModal,private _dossier: DossierEtudServiceService,
