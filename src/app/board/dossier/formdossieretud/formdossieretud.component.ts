...
@Component({
  selector: 'app-formdossieretud',
  templateUrl: './formdossieretud.component.html',
  styleUrls: ['./formdossieretud.component.css']
})
export class FormdossieretudComponent implements OnInit  {
  ...
  constructor(public activeModal: NgbActiveModal,
    ...
    affect(id: any){
      ...
      res=>{
        ...
        this.router.navigate(['/admin/dossier/detailetud' , this.iddossier]));
