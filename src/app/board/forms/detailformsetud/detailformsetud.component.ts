...
@Component({
  ...
  styleUrls: ['detailformsetud.component.css'],
  template: `
    <div class="modal-header">
...
@Component({
  selector: 'app-detailformsetud',
  templateUrl: './detailformsetud.component.html',
  styleUrls: ['./detailformsetud.component.css']
})
export class DetailformsetudComponent implements OnInit , AfterViewInit{
  /*   @HostListener('input', ['$event.target'])
    onInput(textArea:HTMLTextAreaElement):void {
      this.adjust();
    } */
    constructor(private _formData: FormsetudService,
