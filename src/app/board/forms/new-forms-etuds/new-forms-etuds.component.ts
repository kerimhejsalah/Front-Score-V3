...
@Component({
  selector: 'app-new-forms-etuds',
  templateUrl: './new-forms-etuds.component.html',
  styleUrls: ['./new-forms-etuds.component.css']
})
export class NewFormsEtudsComponent implements OnInit, AfterViewInit {

  @HostListener('input', ['$event.target'])
  onInput(textArea: HTMLTextAreaElement): void {
    this.adjust();
  }
  constructor(private formService: FormsetudService,
      ...
      this.formService.createNewForm(this.form).subscribe(
        (res) => {
          ...
          if (!res) {
            ...
            this.router.navigate(['/admin/forms/etud']);
          }
        },
        (err) => {
          this.toastr.error(
