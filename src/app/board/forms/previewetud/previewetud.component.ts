...
@Component({
  selector: 'app-previewetud',
  templateUrl: './previewetud.component.html',
  styleUrls: ['./previewetud.component.scss']
})
export class PreviewetudComponent implements OnInit , AfterViewInit {
